    ...
    <div className="space-y-10 pb-12">
      ...
      <div className="relative bg-white/2 p-8 lg:p-16 rounded-[2rem] lg:rounded-[3rem] text-white overflow-hidden border border-white/5 group">
        <div className="relative z-10 max-w-2xl">
          ...
          >
            <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-indigo-600/10 text-indigo-200 rounded-full text-[8px] lg:text-[10px] font-bold uppercase tracking-widest mb-6 border border-indigo-500/20 backdrop-blur-sm">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Link to="/pharmacy" className="bg-white/5 text-white px-6 lg:px-8 py-4 rounded-2xl font-bold flex items-center justify-center gap-3 hover:bg-white/10 transition-all border border-white/10 text-sm lg:text-base">
        ...
        <div className="absolute top-0 right-0 w-1/2 h-full bg-gradient-to-l from-indigo-600/10 to-transparent -z-0" />
        <div className="absolute -right-20 -top-20 w-96 h-96 bg-indigo-600 rounded-full blur-[120px] opacity-10 group-hover:scale-110 transition-transform duration-1000" />
        <div className="absolute bottom-10 right-10 w-64 h-64 bg-purple-600 rounded-full blur-[100px] opacity-10 group-hover:translate-x-10 transition-transform duration-1000" />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="bg-white/2 p-6 lg:p-10 rounded-[2rem] lg:rounded-[2.5rem] border border-white/5 flex flex-col group">
          <div className="flex items-center justify-between mb-8 lg:mb-10">
            <h3 className="text-xl lg:text-2xl font-display font-bold text-white">Appointments</h3>
...
function VitalCard({ icon: Icon, label, value, status, color }: any) {
  ...
  return (
    <motion.div 
      whileHover={{ y: -5 }}
      className="bg-white/2 p-6 lg:p-8 rounded-[1.5rem] lg:rounded-[2rem] border border-white/5 relative overflow-hidden group"
    >
      <div className="flex items-center justify-between mb-6 relative z-10">
        <div className={`p-3 lg:p-4 rounded-2xl ${colors[color]} border group-hover:scale-110 transition-transform duration-300`}>
...
function PrescriptionItem({ medicine, dosage, duration, status, color }: any) {
  ...
  return (
    <div className="p-6 lg:p-8 flex flex-col sm:flex-row sm:items-center justify-between hover:bg-white/5 transition-all group cursor-pointer border-l-4 border-l-transparent hover:border-l-indigo-600 gap-6">
      ...
      <div className="flex items-center justify-between sm:justify-end gap-4 lg:gap-6">
        ...
        <div className="w-8 h-8 lg:w-10 lg:h-10 flex items-center justify-center bg-white/5 rounded-xl text-gray-500 group-hover:bg-indigo-600 group-hover:text-white group-hover:translate-x-1 transition-all border border-white/5">
